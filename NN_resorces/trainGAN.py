...
def main():
    ...
    gen = UNET(in_channels=6).to("cuda")
    ...
    train_loader = DataLoader(trainset, batch_size=2, shuffle=True, pin_memory=True,num_workers=2)
    ...
    torch.save(disc.state_dict(), "disc-conv.pth")
    torch.save(gen.state_dict(), "gen-conv.pth")
